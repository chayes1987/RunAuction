Public Class Constants
    ...
    Public Const BID_PLACED_ACK_ADR As String = "tcp://*:2350"
    Public Const AUCTION_EVENT_PUB_ADR As String = "tcp://*:2360"
    Public Const AUCTION_RUNNING_PUB_ADR As String = "tcp://*:2370"
